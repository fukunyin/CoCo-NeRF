...
from evaluation.eval import VolSDFTrainRunner
...
if __name__ == '__main__':
    ...
    parser.add_argument('--iter', type=int, default=2000000, help='number of epochs to train for')
    parser.add_argument('--conf', type=str, default='./confs/dtu.conf')
    parser.add_argument('--expname', type=str, default='')
    parser.add_argument("--exps_folder", type=str, default="../volsdf_fp")
